  ...
  try {
    ...
    !function () {
      ...
      _.extend = function (e) {
        ...
        e = String(e);
        var t, r, s, n, a, i, o, c, u = "ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/=", d = 0,
          l = 0, p = "", f = [];
        if (!e) return e;
        e = _.utf8Encode(e);
        do t = e.charCodeAt(d++), r = e.charCodeAt(d++), s = e.charCodeAt(d++), c = t << 16 | r << 8 | s, n = c >> 18 & 63, a = c >> 12 & 63, i = c >> 6 & 63, o = 63 & c, f[l++] = u.charAt(n) + u.charAt(a) + u.charAt(i) + u.charAt(o); while (d < e.length);
      ...
      var t = "\u53d6\u503c\u5f02\u5e38";
      _.isObject(e.properties) && (e.properties.$first_referrer && (e.properties.$first_referrer_host = _.getHostname(e.properties.$first_referrer, t)), "track" === e.type && (e.properties.$referrer && "$pageview" === e.event && (e.properties.$referrer_host = _.getHostname(e.properties.$referrer, t)), sd.para.is_track_latest.referrer && sd.para.is_track_latest.referrer_host && (e.properties.$latest_referrer_host = _.getHostname(e.properties.$latest_referrer, t))))
      ...
      var r = {datasend_timeout: 6e3, send_interval: 6e3, one_send_max_length: 6};
      _.localStorage.isSupport() && _.isSupportCors() && "object" == typeof localStorage ? sd.para.batch_send === !0 ? (sd.para.batch_send = _.extend({}, r), sd.para.use_client_time = !0) : "object" == typeof sd.para.batch_send && (sd.para.use_client_time = !0, sd.para.batch_send = _.extend({}, r, sd.para.batch_send)) : sd.para.batch_send = !1;
      ...
      if ("object" == typeof sd.para.source_type && (sd.para.source_type.utm = _.isArray(sd.para.source_type.utm) ? sd.para.source_type.utm.concat(s) : s, sd.para.source_type.search = _.isArray(sd.para.source_type.search) ? sd.para.source_type.search.concat(n) : n, sd.para.source_type.social = _.isArray(sd.para.source_type.social) ? sd.para.source_type.social.concat(a) : a, sd.para.source_type.keyword = _.isObject(sd.para.source_type.keyword) ? _.extend(i, sd.para.source_type.keyword) : i), _.isObject(sd.para.heatmap) && (sd.para.heatmap.clickmap = sd.para.heatmap.clickmap || "default", sd.para.heatmap.scroll_notice_map = sd.para.heatmap.scroll_notice_map || "default", sd.para.heatmap.scroll_delay_time = sd.para.heatmap.scroll_delay_time || 4e3, sd.para.heatmap.renderRefreshTime = sd.para.heatmap.renderRefreshTime || 1e3, sd.para.heatmap.loadTimeout = sd.para.heatmap.loadTimeout || 1e3), "object" == typeof sd.para.server_url && sd.para.server_url.length) for (t = 0; t < sd.para.server_url.length; t++) /sa\.gif[^\/]*$/.test(sd.para.server_url[t]) || (sd.para.server_url[t] = sd.para.server_url[t].replace(/\/sa$/, "/sa.gif").replace(/(\/sa)(\?[^\/]+)$/, "/sa.gif$2")); else /sa\.gif[^\/]*$/.test(sd.para.server_url) || (sd.para.server_url = sd.para.server_url.replace(/\/sa$/, "/sa.gif").replace(/(\/sa)(\?[^\/]+)$/, "/sa.gif$2"));
      ...
      sd._t = sd._t || 1 * new Date, sd.lib_version = "1.14.9", sd.is_first_visitor = !1, sd.source_channel_standard = "utm_source utm_medium utm_campaign utm_content utm_term"
    }, sd.log = function () {
    ...
    sd.sendState = sendState, sendState.queue = _.autoExeQueue(), sendState.requestData = null, sendState.getSendCall = function (e, t, r) {
      ...
      if (sd.para.use_app_track === !0 || "only" === sd.para.use_app_track) if ("object" == typeof SensorsData_APP_JS_Bridge && (SensorsData_APP_JS_Bridge.sensorsdata_verify || SensorsData_APP_JS_Bridge.sensorsdata_track)) SensorsData_APP_JS_Bridge.sensorsdata_verify ? SensorsData_APP_JS_Bridge.sensorsdata_verify(JSON.stringify(_.extend({server_url: sd.para.server_url}, s))) ? "function" == typeof r && r() : (sd.debug.apph5({
        ...
        step: "3.1",
        output: "all"
      }), this.prepareServerUrl()) : (SensorsData_APP_JS_Bridge.sensorsdata_track(JSON.stringify(_.extend({server_url: sd.para.server_url}, s))), "function" == typeof r && r()); else if (!/sensors-verify/.test(navigator.userAgent) && !/sa-sdk-ios/.test(navigator.userAgent) || window.MSStream) sd.para.use_app_track === !0 && (sd.debug.apph5({
        data: s,
        step: "2",
        output: "all"
        ...
        if (/sensors-verify/.test(navigator.userAgent)) {
          ...
          if (a && a[0] && "string" == typeof a[1] && 2 === a[1].split("?").length) {
            ...
            i && i === a[0] && o && o === a[1] ? (n = document.createElement("iframe"), n.setAttribute("src", "sensorsanalytics://trackEvent?event=" + encodeURIComponent(JSON.stringify(_.extend({server_url: sd.para.server_url}, s)))), document.documentElement.appendChild(n), n.parentNode.removeChild(n), n = null, "function" == typeof r && r()) : (sd.debug.apph5({
              data: s,
              step: "3.2",
              output: "all"
    ...
    saEvent.checkOption = {
      ...
      saNewUser.checkIsAddSign(r), saNewUser.checkIsFirstTime(r), sd.addReferrerHost(r), sd.para.debug_mode === !0 ? (sd.log(r), this.debugPath(JSON.stringify(r), t)) : sd.sendState.getSendCall(r, s, t)
    ...
    var store = sd.store = {
      requests: [], _sessionState: {}, _state: {}, getProps: function () {
      ...
      checkIsAddSign: function (e) {
        ...
        store.setProps(r, !0);
        var n = {};
        if ("" === e && (e = "url\u89e3\u6790\u5931\u8d25"), _.each(sd.para.is_track_latest, function (t, r) {
          if (t) {
        ...
        }), sd.register(n), sd.para.is_track_latest.utm) {
      ...
      setNotice: function (e) {
        ...
        var r = location.search.match(/sa-request-id=([^&#]+)/), s = location.search.match(/sa-request-type=([^&#]+)/),
    ...
    if (sd.init = function (e) {
      ...
      return !(sd.readyState && sd.readyState.state && sd.readyState.state >= 2) && (sd.setInitVar(), sd.readyState.setState(2), sd.initPara(e), void heatmap.prepare(function () {
        t(), _.info.initPage(), sd.para.is_track_single_page && _.addSinglePageEvent(function (e) {
          var t = function (t) {
            t = t || {}, e !== location.href && sd.quick("autoTrack", _.extend({$url: location.href, $referrer: e}, t))
          };
